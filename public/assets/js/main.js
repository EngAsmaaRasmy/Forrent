...
function qualificationSelected(selectedIndex){
    document.getElementById('document').style.display = (selectedIndex >= 2) ? 'block' : 'none';
}
...
$('#myFormId').on('change', function() { // change or input event
    ...
    $inputs.attr('required', anyInputChanged);

  });
  $('#mydateId').on('change', function() {
  var e = document.getElementById("period_unit");
  var valid_days = e.options[e.selectedIndex].value;
  ...
  if(valid_days == 7 || valid_days == 30)
  {
    end_date.setDate(end_date.getDate() + parseInt(valid_days));
    // console.log(end_date);
    var end= $('#end_date').val( (end_date.getMonth() + 1)+ '/' + (end_date.getDate() )+ '/' + end_date.getFullYear() );
  } else {
    end_date.setDate(end_date.getDate() + parseInt(day));
    // console.log(end_date);
    var end= $('#end_date').val( (end_date.getMonth() + 1)+ '/' + (end_date.getDate() )+ '/' + end_date.getFullYear() );
    // getMonth() + 1)+ '/' + (end_date.getDate() ) + '/' + end_date.getFullYear() 
  }
...
if ( $.fn.countdown ) {
    $('[data-countdown]').each(function() {
        ...
        $this.countdown(finalDate, function(event) {
          $this.html(event.strftime(' %Y:%m:%d'));
        });
     });
    ...
    if (typeof noUiSlider === 'object') {
        ...
        //         dateFormat = ( !$this.data('format') ) ? 'YOD' : $this.data('format'),
        ...
        //     }
        //     // alert(newDate)
        //     var newYear = new Date((new Date()).valueOf() + 1000*3600*24);
