...
<nav aria-label="breadcrumb" class="breadcrumb-nav ">
    <div class="container">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"><a href="{{route ('visitors.index')}}">{{trans('site.services')}}</a></li>
            {{-- <li class="breadcrumb-item">{{trans('site.se')}}</li> --}}
        </ol>  
    </div><!-- End .container -->
            ...
            <div class="page-content">
                <div class="container">
                    <div class="row">
                        <!-- row opened -->
                        <div class="col-lg-8">
                            <div class="col-8 col-md-8 col-lg-8 m-auto mb-2">
                                <div class="product product-7 text-center">
                                       <div class="product-body">
                                        @if($category->poster_image != null)
                                        <a href="{{$category->poster_link}}">
                                            <img style="height: 20vh;" src="{{asset('uploads/posters/'.$category->poster_image)}}" alt="{{$category->name}}" class="product-image">
                                        </a> 
                                        @else
                                        <a href="{{route ('home')}}">
                                            <img style="height: 20vh;" src="{{asset('assets/images/05.jpg')}}" alt="poster" class="product-image">
                                        </a>
                                        @endif 
                                        ...
                                        <div class="collapse show" id="widget-2">
                                            <div class="widget-body">
                                                <div class="filter-items filter-items-count">
                                                    ...
                                                    <div class="filter-item">
                                                        <div class="custom-control custom-checkbox">
                                                            <input type="checkbox" value="{{ $area->id }}" name="area_id[]" class="custom-control-input" id="{{ $area->id }}">
