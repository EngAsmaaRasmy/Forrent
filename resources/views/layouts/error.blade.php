...
<head>
    ...
    <!-- Main CSS File -->
    <link rel="stylesheet" href="{{ asset('assets/css/ltrstyle.css')}}">
...
<body>
        <div class="notfound-copy">
                {{-- <svg aria-labelledby="Error" alt="404 Page not found" class="not-found">
              ...
              <p>
                @isset($title)
                        ...
                        @if($homeLink ?? false)
                        <a href="{{ url('/') }}" class="btn btn-primary font-bold underline transition duration-300 hover:text-blue-600">Go home</a>
                        @endif
                </p>
              </div>
